...
There was an old lady who swallowed #{@animals.fetch(1)[:indefinite_determiner]} #{@animals.fetch(1)[:name]};
That wriggled and wiggled and tickled inside her.
She swallowed the #{@animals.fetch(1)[:name]} to catch the #{first_animal};
I don't know why she swallowed #{first_animal_indefinite_determiner} #{first_animal} - perhaps she'll die!
There was an old lady who swallowed a bird;
How absurd to swallow a bird.
She swallowed the bird to catch the #{@animals.fetch(1)[:name]},
She swallowed the #{@animals.fetch(1)[:name]} to catch the #{first_animal};
I don't know why she swallowed #{first_animal_indefinite_determiner} #{first_animal} - perhaps she'll die!
